<?php namespace Modules\Marketplace\Providers;
...
class MarketplaceServiceProvider extends ServiceProvider {
	...
	{
		$viewPath = base_path('resources/views/modules/marketplace');
	...
	{
		$langPath = base_path('resources/lang/modules/marketplace');
